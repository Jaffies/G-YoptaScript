YoptaWords = { -- Глобальной делаем для того, чтобы какие нибудь магистры на кодерах всяких darkrp серверов смогли увеличить количество слов
	...
	{"ебнутьХуйБотярам", "Add_NPC_Class"},
	{"хуйнутьЙоптуКлиенту", "AddCSLuaFile"},
	...
	{"дерьмо.крутится", "Derma_Anim"},
	{"дерьмо.пиздаЗаднику", "Derma_DrawBackgroundBlur"},
	{"дерьмо.крюк", "Derma_Hook"},
	{"дерьмо.опаЧикуля", "Derma_Install_Convar_Functions"},
	{"дерьмо.малява" ,"Derma_Message"},
	{"дерьмо.пиздеж", "Derma_String_Request"},
	{"дерьмо.хули", "Derma_Query"},
	{"дерьмо.ебало", "DermaMenu"},
	{"отхуяритьМаляров","DisableClipping"},
	{"гуф.ебнуть", "DOF_Kill"},
	{"гуф.оживить", "DOF_Start"},
	{"гуф.программист", "DOFModelHack"},
